<template>
  <el-upload :class="{ disabled: uploadCardHidden }" list-type="picture-card" :limit="1" :auto-upload="true"
    :http-request="unloaded" ref="uploadRef">
    <el-icon>
  ...
  <!-- 图片裁剪弹出框 -->
  <el-dialog v-model="dialogCropperVisible" title="裁剪" width="600px" :show-close="false" class="dialog">
    <div class="box">
      <div class="crop-box">
